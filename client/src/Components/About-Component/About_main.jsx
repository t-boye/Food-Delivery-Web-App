...
function About() {
  ...
  const [process, setProcessed] = useState(
    Math.floor(Math.random() * maxCheck) + 1
  );
  ...
  useEffect(() => {
    const intervalId = setInterval(() => {
      setOrders((prevOrders) => {
        ...
        setServed(
          (prevServed) => prevServed + Math.floor(Math.random() * 10) + 1
        );

        // Increase processed by a random value
        setProcessed(
          (prevProcessed) => prevProcessed + Math.floor(Math.random() * 10) + 1
        );
      ...
      <div className="relative flex flex-col items-center justify-center bg-gray-100 pt-24 pb-24">
        ...
        <div className="flex flex-wrap md:flex-row gap-10 overflow-hidden max-w-7xl mx-auto rounded-xl pb-10 shadow-md md:shadow-8xl justify-center">
          <div className="md:text-center w-full md:w-1/2 px-8">
            ...
            <p className="text-gray-800 text-2xl mb-8 leading-loose">
              My Food App is your one-stop shop for discovering exciting
              culinary experiences. We connect you with a wide variety of
              restaurants and cuisines, offering a convenient and delightful way
              to explore the world of food.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col pt-16 gap-10 max-w-7xl mx-4 mr-8 md:flex-row md:items-left md:justify-between">
          <div className="md:w-1/2 relative">
            <div className="pl-8 mb-8 md:text-left">
              ...
              <p className="text-gray-600 text-2xl pt-8 text-center md:text-left mb-10 leading-loose">
                Connecting passionate foodies with hidden culinary gems and
                empowering them to discover a world of flavorful experiences. We
                eliminate the "what should I eat?" dilemma by providing a
                seamless platform for discovering amazing local restaurants and
                sharing authentic reviews. We celebrate culinary diversity,
                support independent restaurants, and promote joyful food
                adventures, one bite at a time.
              </p>
            </div>
          </div>
          <div className="md:w-1/2">
            <div className="pl-8">
              <img
                src="https://i.postimg.cc/mD4K8st3/e0a3f89b63c5b082120b9bc70cee629a.jpg"
                className="pt-16 pr-8 mb-10 leading-loose"
              />
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col-reverse pt-16 gap-10 max-w-7xl mx-4 mr-8 md:flex-row md:items-center md:justify-between">
          <div className="md:w-1/2 relative">
            <div className="pl-8">
              <img
                src="https://i.postimg.cc/ncqBVMVt/9f68850c32f2a38104e0b007a26896d1.jpg"
                className="pt-8 pr-8 mb-10 leading-loose"
              ></img>
            </div>
          </div>
          <div className="md:w-1/2">
            <div className="pl-8">
              ...
              <p className="text-gray-600 text-2xl pt-8 text-center md:text-left mb-10 leading-loose">
                We envision a world where every hungry diner has instant access
                to a wealth of local culinary treasures.
                <br />
                My Food App will be the go-to platform for restaurants to
                attract new customers and users to explore a diverse range of
                flavors.
                <br />
                <br />
                We strive to be the leading force in connecting food lovers with
                the perfect bite, building a vibrant and connected community
                where everyone can share their passion for food.
              </p>
            </div>
          </div>
        </div>
