...
const MenuCard = () => {
  ...
  <div className="p-[10px] text-white">
    ...
    <p className="description text-base md:text-lg pt-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce semper nulla in ex tincidunt, eu eleifend massa rutrum.</p>
  </div>
