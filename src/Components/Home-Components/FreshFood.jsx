  ...
  return (
    <div className="w-full h-[80vh] flex flex-col md:flex-row items-center justify-center mt-8">
      <div className="md:w-1/2 px-8 md:px-0">
        <img
          className="h-[400px] md:h-[360px] hidden md:block"
          src={Freshfruit}
          alt="Fresh Food"
        />
      </div>
      <div className="w-full md:w-1/2 flex flex-col md:text-2xl mr-16 text-white text-center">
        ...
        <p className="leading-8 py-7 tracking-wider px-5">
          Experience the goodness of fresh, healthy, organic, and delicious fruits.
          Indulge in nature's finest offerings with our wide selection of
          nutrient-rich fruits. From vibrant berries to juicy tropical favorites,
          our fruits are carefully sourced to ensure premium quality and
          exceptional taste.
        </p>
        <div className="justify-center my-8 md:my-16">
          <a
